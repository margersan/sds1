...
public class RecordService {
	...
	public Page<RecordDTO> findByMoments(Instant minDate, Instant maxDate, PageRequest pageRequest) { //método criado automaticamente
		return repository.findByMoments(minDate, maxDate, pageRequest).map(x -> new RecordDTO(x)); //criação do método no RecordRepository
	}
}
